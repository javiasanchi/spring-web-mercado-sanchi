...
public class App {
    ...
    public static void main(String[] args) {
        ...
        var prod10 = new Productos(null,"Morcilla de Burgos Ibérico","La morcilla de burgos es un embutido sin carne que se rellena con sangre coagulada (en la mayoría de los casos de cerdo), arroz extra, manteca de cerdo, sal y cebolla horcal; y es aderezada con especias para conseguir su sabor característico (principalmente pimienta y pimentón.", 140D, 12.29, LocalDate.of(2023,1,11),LocalDate.of(2024,3,17), 130,true);
